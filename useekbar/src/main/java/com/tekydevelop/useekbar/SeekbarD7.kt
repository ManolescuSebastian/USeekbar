...
class SeekbarD7 : BaseSeekbar {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (i in 0..steps) {
            ...
            canvas.drawRect(segmentRectF, tooltipBackgroundPaintFill)
            canvas.drawRect(segmentRectF, tooltipBackgroundPaint)
        }
        ...
        tooltipRectF.set(
            x + boundsWidth - Constants.SHAPE_STROKE_WIDTH,
